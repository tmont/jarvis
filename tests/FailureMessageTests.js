var suite = Jarvis.suite('Failure message tests', [
	Jarvis.suite('Equality failure messages', [
		...
		Jarvis.suite('Teests that require htmlDiffs to be false', (function() {
	...
	Jarvis.suite('Other constraint failure message', [
	...
	Jarvis.suite('Negated failure messages', [
